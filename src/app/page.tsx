...
import { Dumbbell, ArrowRight, Video, Target, TrendingUp, MessageCircle } from 'lucide-react'
    ...
    <div className="min-h-screen bg-background flex flex-col font-sans">
      ...
      <main className="flex-1 flex flex-col items-center justify-center text-center px-4 py-20 bg-grid-white/[0.02] relative overflow-hidden">
        ...
        <div className="max-w-4xl mx-auto space-y-8">
          <div className="inline-flex items-center rounded-full border border-primary/30 bg-primary/10 px-3 py-1 text-sm text-primary font-medium mb-4">
            🚀 Bienvenido a la fase Ultimate Coaching
          </div>
          ...
          <p className="text-xl text-muted-foreground max-w-2xl mx-auto leading-relaxed">
            Jimi.coach es tu plataforma exclusiva de entrenamiento CrossFit. 
            Recibe tu planificación semanal estructurada, registra tu esfuerzo real (RPE) y sube videos para obtener feedback técnico personalizado del Coach Jimi.
          </p>
        ...
        {/* Feature Grid */}
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8 mt-32 max-w-5xl mx-auto w-full text-left">
          ...
          <div className="p-6 rounded-2xl glass border border-border/50">
            ...
            <p className="text-muted-foreground">Sube enlaces de tus levantamientos y recibe correcciones técnicas directas para mejorar tu forma.</p>
          </div>
          <div className="p-6 rounded-2xl glass border border-border/50">
            <div className="w-12 h-12 rounded-lg bg-primary/20 flex items-center justify-center mb-4 text-primary">
      ...
      {/* WhatsApp CTA */}
      <section className="border-t border-border/50 bg-secondary/30 py-16 text-center px-4">
        <h2 className="text-2xl font-bold mb-6">¿Tienes alguna duda que aclarar con el Coach Jimi?</h2>
        <a href="http://wa.me/56972878295" target="_blank" rel="noopener noreferrer">
          <Button size="lg" className="bg-[#25D366] hover:bg-[#128C7E] text-white gap-2 font-bold h-14 px-8 shadow-lg hover:scale-105 transition-transform">
